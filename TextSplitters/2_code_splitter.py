from langchain_classic.text_splitter import PythonCodeTextSplitter, RecursiveCharacterTextSplitter, Language

# Code splitter- ------------------------------------------------------------------------------ Splits at code syntax
code_text = """#!/usr/local/bin/python
...
if __name__ == "__main__":
    main()"""
code_splitter = PythonCodeTextSplitter(chunk_size=100, chunk_overlap=0)
code_chunks = code_splitter.split_text(code_text)
print("Code Splitter Output:")
print(code_chunks[1])

# Recursive Character Text Splitter- ------------------------------------------------ Splits at language-specific boundaries
text_splitter = RecursiveCharacterTextSplitter.from_language(
    language=Language.PYTHON, chunk_size=100, chunk_overlap=0
)   
text_chunks = text_splitter.split_text(code_text)
print("Recursive Character Text Splitter Output:")
print(text_chunks[1])